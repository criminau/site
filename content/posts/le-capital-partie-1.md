...
cover:
    image: "media/industry-4k-cover-4.avif"
    alt: "Industrie"
images: "media/industry-4k-cover-4.avif"
...
Le capital commercial est celui qui créé la survaleur.
...
#### c + v = C
A la fin, nous avons : c + v + s = C' où s est la survaleur..
...
La valeur d'échange doit venir de la charge de travail humaine (dans un premier temps) /ou de l'importance de la marchandise par rapport au besoin (et/ou désir) ? /ou de la quantité d'énergie dépensée.
